...
export default function About({type, template, service, userid} ) {
  ...
  return (
    <div className="dark:bg-stone-900 dark:text-gray-50 w-full">
      <div className="container mx-auto w-11/12 md:max-w-screen-lg pt-10">
        <div className="text-4xl font-bold text-center mb-4">About me</div>
        <div className="flex flex-col md:flex-row gap-2 bg-white 
        shadow-md rounded px-8 pt-6 pb-8 mb-4 outline outline-1 outline-gray-200
        dark:outline-neutral-900 dark:bg-neutral-800">
        ...
        <form className="bg-white shadow-md rounded px-8 pt-6 pb-14 outline outline-1 outline-gray-200 dark:outline-neutral-900 dark:bg-neutral-800" onSubmit={sendEmail}>
          ...
          <div className="mt-4">
            <label className="text-gray-700 text-lg font-bold dark:text-gray-300">Name</label>
            <input type="text" className="mt-2 shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 dark:text-gray-400 dark:bg-stone-900 dark:border-neutral-900 leading-tight focus:outline-none focus:shadow-outline" placeholder="Your name is?" name="name" required />
          </div>
          <div className="mt-4">
            <label className="text-gray-700 text-lg font-bold dark:text-gray-300">Email</label>
            <input type="email" className="mt-2 shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 dark:text-gray-400 dark:bg-stone-900 dark:border-neutral-900 leading-tight focus:outline-none focus:shadow-outline" placeholder="Write your email" name="email" required />
          </div>
          <div className="mt-4">
            <label className="text-gray-700 text-lg font-bold dark:text-gray-300">Subject</label>
            <input type="text" className="mt-2 shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 dark:text-gray-400 dark:bg-stone-900 dark:border-neutral-900 leading-tight focus:outline-none focus:shadow-outline" placeholder="What topic you want to talk about?" name="subject" required/>
          </div>
          <div className="mt-4">
            <label className="text-gray-700 text-lg font-bold dark:text-gray-300">Content</label>
            <textarea rows="5"  className="mt-2 shadow appearance-none border rounded w-full py-4 px-3 text-gray-700 dark:text-gray-400 dark:bg-stone-900 dark:border-neutral-900 leading-tight focus:outline-none focus:shadow-outline" placeholder="Email size doesn't matter ;)" name="content" required/>
          </div>
